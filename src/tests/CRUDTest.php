...
final class CRUDTest extends TestCase
{
    public function testCRUD(): void
    {
        ...
        //Insert data into db
        $result = $dc->create($dc::TABLE_BICYCLES, $test_bicycle);
        $this->assertTrue($result);
        //Check if data was correctly added
        $result = $dc->get_by_keyword($dc::TABLE_BICYCLES, $test_array["name"]);
        ...
        $result = $dc->update($dc::TABLE_BICYCLES, $new_bicycle);
        $this->assertTrue($result);
        ...
        //Delete this bicycle
        $result = $dc->delete_bicycle($dc::TABLE_BICYCLES, $id);
        $this->assertTrue($result);
